...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get forgetPasswordQ => 'هل نسيت كلمة المرور؟';
  ...
  String get introText1 =>
      'اختر ثيمك ولغتك المفضلة لتبدأ بتجربة مريحة ومصممة خصيصًا لتناسب أسلوبك.';

  @override
  String get findEventsThatInspireYou => 'اكتشف فعاليات تُلهمك';

  @override
  String get introText2 =>
      'انغمس في عالم من الفعاليات المصممة لتناسب اهتماماتك الفريدة. سواء كنت من محبي الموسيقى الحية أو ورش الفنون أو الشبكات المهنية أو مجرد اكتشاف تجارب جديدة، لدينا ما يناسب الجميع. توصياتنا المختارة بعناية ستساعدك على الاستكشاف والتواصل والاستفادة القصوى من كل فرصة من حولك.';
  ...
  String get introText3 =>
      'تخلص من عناء تنظيم الفعاليات مع أدوات التخطيط الشاملة لدينا. بدءًا من إرسال الدعوات وإدارة الردود إلى جدولة التذكيرات وتنسيق التفاصيل، نحن نوفر لك كل ما تحتاجه. خطط بسهولة وركز على الأهم – خلق تجربة لا تُنسى لك ولضيوفك.';
